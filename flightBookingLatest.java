package TestNG;
	...
	public class flightBookingLatest {
		@Test
		public void VerifyFlights() throws InterruptedException {
			WebDriver driver = WebDriverManager.edgedriver().create();
			driver.get("https://www.booking.com/");
			driver.manage().window().maximize();
			WebElement flight = driver.findElement(By.xpath("//span[normalize-space()='Flights']"));
			...
			// for selecting which type of flight
			...
			Thread.sleep(5000);
			//Arrival Timings
			driver.findElement(By.xpath("(//span[@class ='InputCheckbox-module_field__R4nYQ'])[7]")).click();
			Thread.sleep(5000);
			//Best Tab
			...
			System.out.println("The price of the Cheapest Flight for a single traveller is = " + lowest);
			Thread.sleep(5000);
			//Total cheap price for all passengers
			WebElement PriceofCheapestflightAll = driver.findElement(By.xpath("(//div[@data-test-id = 'flight_card_price_total_price'])[1]"));
			Thread.sleep(5000);
			String lowestAll = PriceofCheapestflightAll.getText();
			System.out.println("The price of the Cheapest Flight is  = " + lowestAll);
			Thread.sleep(5000);
